...
Branch `main`, HEAD em `9a58b21`. Working tree deve estar limpo (todas as mudanças da sessão foram commitadas, uma feature por commit). Rodar `git log --oneline` pra ver o histórico completo (42 commits desde o protótipo inicial).
